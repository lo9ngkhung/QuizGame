 ...
 * @author longp
 */
public class XoaCauHoi extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(23, 73, 640, 91);
        ...
        txtTrinhDo.setBounds(420, 10, 89, 30);
        ...
        btnLuu.setBounds(565, 10, 100, 33);
        ...
        jLabel2.setBounds(340, 10, 80, 30);
        ...
        jLabel5.setBounds(350, 190, 50, 20);

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Câu D:");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(350, 260, 50, 20);

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Câu C:");
        getContentPane().add(jLabel7);
        jLabel7.setBounds(20, 260, 50, 20);
        ...
        jTabbedPane1.setBounds(20, 360, 640, 190);
...
//        String update = "UPDATE BODE SET TRINHDO = '" + trinhdo + "', NOIDUNG = N'" + noidung + "', A = N'" + a + "', B = N'" + b + "', C = N'" + c + "', D = N'" + d + "', DAP_AN =  '" + dapan + "' WHERE CAUHOI = " + cauhoi + " ";
        String delete = "DELETE FROM BODE WHERE CAUHOI = " + cauhoi + " ";
        try {
            ...
            Logger.getLogger(XoaCauHoi.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(XoaCauHoi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
