 ...
 * @author longp
 */
public class SuaCauHoi extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnLuu.setBounds(616, 11, 110, 40);
        ...
        btnThoat.setBounds(20, 10, 110, 40);
        ...
        jLabel1.setBounds(170, 10, 47, 30);
        ...
        jLabel2.setBounds(410, 10, 56, 30);
        ...
        jLabel4.setBounds(23, 203, 60, 17);

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Câu B:");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(400, 200, 60, 17);

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Câu D:");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(406, 268, 70, 17);

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Câu C:");
        getContentPane().add(jLabel7);
        jLabel7.setBounds(23, 268, 60, 17);

        rbtA.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                rbtAMouseClicked(evt);
            }
        });
        ...
        rbtB.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                rbtBMouseClicked(evt);
            }
        });
        ...
        jTabbedPane1.addTab("Quản lý câu hỏi", jScrollPane3);

        getContentPane().add(jTabbedPane1);
        jTabbedPane1.setBounds(10, 350, 730, 210);
        jTabbedPane1.getAccessibleContext().setAccessibleName("Quản lý câu hỏi");

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/qlserver/maxresdefault.jpg"))); // NOI18N
        getContentPane().add(jLabel8);
        jLabel8.setBounds(4, 0, 750, 570);
...
//        String them = "INSERT INTO BODE(CAUHOI,TRINHDO,NOIDUNG,A,B,C,D,DAP_AN) VALUES (" + cauhoi + ",'" + trinhdo + "',N'" + noidung + "',N'" + a + "',N'" + b + "',N'" + c + "',N'" + d + "','" + dapan + "')";
            String update = "UPDATE BODE SET TRINHDO = '" + trinhdo + "', NOIDUNG = N'" + noidung + "', A = N'" + a + "', B = N'" + b + "', C = N'" + c + "', D = N'" + d + "', DAP_AN =  '" + dapan + "' WHERE CAUHOI = " + cauhoi + " ";
            try {

                PreparedStatement pst = dbConnection.prepareStatement(update);
                int rs = pst.executeUpdate();
                if (rs != 0) {
                    JOptionPane.showMessageDialog(null, "SỬA THÀNH CÔNG CÂU HỎI","Information",JOptionPane.INFORMATION_MESSAGE);
                    clearAllInputField();
                    LoadData();
                } else {
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        ...
        if (jTable2.getSelectedRow() >= 0) {
            txtCauHoi.setText(jTable2.getValueAt(jTable2.getSelectedRow(), 0) + "");
            txtTrinhDo.setText(jTable2.getValueAt(jTable2.getSelectedRow(), 1) + "");
            txtNoiDung.setText(jTable2.getValueAt(jTable2.getSelectedRow(), 2) + "");
            txtA.setText(jTable2.getValueAt(jTable2.getSelectedRow(), 3) + "");
            txtB.setText(jTable2.getValueAt(jTable2.getSelectedRow(), 4) + "");
            txtC.setText(jTable2.getValueAt(jTable2.getSelectedRow(), 5) + "");
            txtD.setText(jTable2.getValueAt(jTable2.getSelectedRow(), 6) + "");
            String dapan = (String) jTable2.getValueAt(jTable2.getSelectedRow(), 7);
    ...
    private void rbtBMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rbtBMouseClicked

    }//GEN-LAST:event_rbtBMouseClicked

    private void rbtAMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rbtAMouseClicked

    }//GEN-LAST:event_rbtAMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SuaCauHoi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
